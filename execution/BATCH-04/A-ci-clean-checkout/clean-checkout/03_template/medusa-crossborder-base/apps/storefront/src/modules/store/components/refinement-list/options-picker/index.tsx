...
const OptionsPicker = ({
  ...
  return (
    <div className={compact ? "ph-options-picker ph-options-picker--compact" : "ph-options-picker flex flex-col gap-y-4"}>
      ...
      <Accordion.Root
        ...
        className="ph-options-accordion flex flex-col gap-y-3 pr-6"
      >
        {options.map((option) => {
          const values =
            option.values
          ...
          return (
            ...
            >
              <Accordion.Header>
                <Accordion.Trigger className="ph-option-trigger flex w-full items-center justify-between py-3 text-left">
              ...
              <Accordion.Content className="ph-option-content pb-4 pt-1">
                <div className="ph-option-values flex flex-wrap gap-2">
                  {values.map((value) => {
                    ...
                    return (
                      <button
                        ...
                        className={clsx(
                          "ph-option-value border-ui-border-base border text-small-regular h-10 rounded-rounded px-3 flex items-center transition-colors duration-150",
                          {
