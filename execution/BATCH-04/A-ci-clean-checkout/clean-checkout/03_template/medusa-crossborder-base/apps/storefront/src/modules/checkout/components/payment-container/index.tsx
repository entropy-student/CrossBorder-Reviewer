...
const PaymentContainer: React.FC<PaymentContainerProps> = ({
  ...
  return (
    <RadioGroupOption
      ...
      disabled={disabled}
      className={clx(
        "ph-payment-option flex flex-col gap-y-2 text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:shadow-borders-interactive-with-active",
        {
