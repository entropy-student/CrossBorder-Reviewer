...
const shippingPattern = new RegExp(process.env.MEDUSA_SMOKE_SHIPPING_PATTERN || (country === 'us' ? 'Test US Standard Shipping|US Standard Shipping' : 'Test Standard Shipping|Standard Shipping'), 'i')
